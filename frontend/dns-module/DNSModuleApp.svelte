<script>
  ...
  const strings = {
    ru: {
      ...
      readOnly:'Управляется Keenetic автоматически', physicalCount:'Нативных записей', moduleError:'DNS-модуль недоступен',
    ...
    en: {
      ...
      readOnly:'Managed automatically by Keenetic', physicalCount:'Native entries', moduleError:'DNS module unavailable',
