...
<svelte:head><title>RouterForge — DNS Трафик</title></svelte:head>

<div class="page">
  <DNSNav />
  <div class="page-head"><div><h1>DNS Трафик</h1><p>DNS flow, клиенты, интерфейсы, домены и временная история.</p></div><span class="page-kicker mono">LIVE / {$snapshot.flow?.length||0} EVENTS</span></div>
