...
def main():
    ...
    lines = [
        ...
        '    fi',
        '    awk ''/^processor[[:space:]]*:/ { n++ } END { print n + 0 }'' /proc/cpuinfo 2>/dev/null || printf ''0\n''',
        "}",
        "",
        "hardware_preflight() {",
        ...
        "",
        '    say ""',
        '    say "Detected hardware / РћР±РЅР°СЂСѓР¶РµРЅРЅРѕРµ РѕР±РѕСЂСѓРґРѕРІР°РЅРёРµ:"',
        '    say "RAM: ${ram_mib} MiB"',
        ...
        '    single_core=0',
        "",
        '    [ "$ram_mib" -gt 0 ] && [ "$ram_mib" -le 128 ] && low_ram=1',
        '    [ "$cpu_cores" -eq 1 ] && single_core=1',
        "",
        '    if [ "$low_ram" -eq 1 ] && [ "$single_core" -eq 1 ]; then',
        '        say ""',
        '        say "РџР Р•Р”РЈРџР Р•Р–Р”Р•РќРР•: РѕР±РЅР°СЂСѓР¶РµРЅРѕ СѓСЃС‚СЂРѕР№СЃС‚РІРѕ СЃ 128 РњР‘ РћР—РЈ РёР»Рё РјРµРЅСЊС€Рµ Рё РѕРґРЅРѕСЏРґРµСЂРЅС‹Рј РїСЂРѕС†РµСЃСЃРѕСЂРѕРј."',
        '        say "РЈСЃС‚Р°РЅРѕРІРєР° RouterForge СЂР°Р·СЂРµС€РµРЅР°, РЅРѕ СЃС‚Р°Р±РёР»СЊРЅР°СЏ СЂР°Р±РѕС‚Р° Рё РїСЂРѕРёР·РІРѕРґРёС‚РµР»СЊРЅРѕСЃС‚СЊ РЅРµ РіР°СЂР°РЅС‚РёСЂСѓСЋС‚СЃСЏ."',
        '        if [ "$swap_mib" -gt 0 ]; then',
        '            say "РђРєС‚РёРІРЅС‹Р№ swap РѕР±РЅР°СЂСѓР¶РµРЅ: ${swap_mib} MiB."',
        '        else',
        '            say "РќР°СЃС‚РѕСЏС‚РµР»СЊРЅРѕ СЂРµРєРѕРјРµРЅРґСѓРµС‚СЃСЏ РЅР°СЃС‚СЂРѕРёС‚СЊ swap-СЂР°Р·РґРµР» РёР»Рё swap-С„Р°Р№Р» РЅР° USB-РЅР°РєРѕРїРёС‚РµР»Рµ."',
        '        fi',
        '        say ""',
        ...
        '        say ""',
        '        say "РџР Р•Р”РЈРџР Р•Р–Р”Р•РќРР•: РѕР±РЅР°СЂСѓР¶РµРЅРѕ 128 РњР‘ РћР—РЈ РёР»Рё РјРµРЅСЊС€Рµ."',
        '        if [ "$swap_mib" -gt 0 ]; then',
        '            say "РђРєС‚РёРІРЅС‹Р№ swap РѕР±РЅР°СЂСѓР¶РµРЅ: ${swap_mib} MiB."',
        '        else',
        '            say "Р”Р»СЏ СЃС‚Р°Р±РёР»СЊРЅРѕР№ СЂР°Р±РѕС‚С‹ RouterForge СЂРµРєРѕРјРµРЅРґСѓРµС‚СЃСЏ РЅР°СЃС‚СЂРѕРёС‚СЊ swap-СЂР°Р·РґРµР» РёР»Рё swap-С„Р°Р№Р» РЅР° USB-РЅР°РєРѕРїРёС‚РµР»Рµ."',
        '        fi',
        '        say ""',
        ...
        '        say ""',
        '        say "РџР Р•Р”РЈРџР Р•Р–Р”Р•РќРР•: РѕР±РЅР°СЂСѓР¶РµРЅ РѕРґРЅРѕСЏРґРµСЂРЅС‹Р№ РїСЂРѕС†РµСЃСЃРѕСЂ."',
        '        say "RouterForge РјРѕР¶РЅРѕ СѓСЃС‚Р°РЅРѕРІРёС‚СЊ, РЅРѕ СЃС‚Р°Р±РёР»СЊРЅР°СЏ СЂР°Р±РѕС‚Р° Рё РїСЂРѕРёР·РІРѕРґРёС‚РµР»СЊРЅРѕСЃС‚СЊ РЅР° С‚Р°РєРѕРј СѓСЃС‚СЂРѕР№СЃС‚РІРµ РЅРµ РіР°СЂР°РЅС‚РёСЂСѓСЋС‚СЃСЏ."',
        '        say ""',
